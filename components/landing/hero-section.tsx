    ...
    <section className="relative min-h-screen flex flex-col justify-center items-start overflow-hidden bg-black">
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        <div className="lg:max-w-[65%]">
          ...
          <div className="mb-12">
            <h1 
              className={`text-left text-[clamp(2.2rem,6vw,7rem)] font-display leading-[0.92] tracking-tight text-white transition-all duration-1000 ${
          ...
          >
            <Link href="#convert">
              <Button size="lg" className="rounded-full bg-purple-600 hover:bg-purple-700 text-white font-medium px-8 h-12">
                Convert Now
              </Button>
            </Link>
            <Link href="#how-it-works">
              <Button size="lg" variant="outline" className="rounded-full border-white/20 text-white hover:bg-white/10 font-medium px-8 h-12">
                Learn Process
              </Button>
            </Link>
          </div>
        ...
        <div className="max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20">
          {[
            ...
            <div key={stat.label} className="flex flex-col gap-2">
              <span className="text-3xl lg:text-4xl font-display text-white" dangerouslySetInnerHTML={{ __html: stat.value }} />
