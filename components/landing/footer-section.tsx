...
const footerLinks = {
  Converters: [
    ...
    { name: 'SVG to PDF', href: '/tools/svg-to-pdf' },
    { name: 'CSV to PDF', href: '/tools/csv-to-pdf' },
  ...
  Utilities: [
    ...
    { name: 'N-up PDF', href: '/tools/n-up-pdf' },
    { name: 'Booklet Maker', href: '/tools/booklet-pdf' },
    { name: 'Adjust Margins', href: '/tools/adjust-pdf-margins' },
    { name: 'Equalize Page Sizes', href: '/tools/equalize-pdf-page-sizes' },
    { name: 'Extract Images', href: '/tools/extract-pdf-images' },
    { name: 'Export Form Data', href: '/tools/export-pdf-form-data' },
    { name: 'PDF to Audio', href: '/tools/pdf-to-audio' },
    { name: 'Batch Rubber Stamp', href: '/tools/stamp-pdf' },
    { name: 'PDF Reading Themes', href: '/tools/pdf-reading-themes' },
    { name: 'Security Auditor', href: '/tools/pdf-security-auditor' },
    { name: 'PDF TOC Builder', href: '/tools/pdf-toc-builder' },
  ],
  Resources: [
