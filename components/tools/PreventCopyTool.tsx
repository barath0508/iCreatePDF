        ...
        <div className="lg:col-span-8 space-y-6 flex flex-col">
          {!file ? (
            <div
              ...
              className={`cursor-pointer border border-dashed rounded-2xl p-12 transition-all text-center flex-1 flex flex-col items-center justify-center min-h-[220px] ${
