...
export const metadata: Metadata = {
  ...
  keywords: 'online ocr pdf, scan to pdf text, free ocr online pdf, pdf text scanner, convert a pdf image to text, scanned text, scanned pdf to text, ocr conversion pdf, pdf to text scanner, scan text from pdf, pdf ocr to text, free ocr pdf to text, turn scanned document into text, convert a scanned document to editable text, scanned document to text, scanned pdf to text converter, ocr pdf to text, ocr convert scanned pdf to text, convert ocr pdf, ocr convert pdf to text, convert pdf to machine readable format, scan and ocr pdf, convert scanned pdf to editable text, convert scanned pdf to text online free, pdf scan ocr, pdf scan to text, scanned pdf ocr to text, pdf ocr online, extract text from pdf, convert scanned pdf to text, local pdf ocr',
