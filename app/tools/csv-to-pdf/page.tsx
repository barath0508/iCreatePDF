...
export const metadata: Metadata = {
  ...
  keywords: 'csv to pdf converter, convert csv to pdf online, csv to pdf table, format csv as pdf free, csv file to pdf generator, private csv pdf converter, spreadsheet data to pdf report, csv to printable pdf, tabular data to pdf converter, auto fit csv to pdf, convert excel csv to pdf free',
  ...
  return (
    <ToolPageShell
      jsonLd={[
        ...
        faqSchema(toolContent['csv-to-pdf'].faqs),
        howToSchema({
          name: 'CSV to PDF Table Converter',
          description: toolContent['csv-to-pdf'].overview,
          url: '/tools/csv-to-pdf',
          steps: toolContent['csv-to-pdf'].steps,
        }),
