...
export const metadata: Metadata = {
  title: 'Convert PDF to Readable Text Online Free | iCreatePDF',
  description: 'Convert PDF to readable text online for free. Extract raw text layouts from PDF documents page-by-page 100% locally in your browser without uploading files.',
