...
export default function HowTo_convert_svg_to_pdfPage() {
  return (
      ...
      <main className="pt-24 pb-20">
        <article className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-sm text-foreground/80 leading-relaxed">
            ...
            <p>Convert Scalable Vector Graphics (.svg) files into high-resolution vector PDF documents.</p>
            ...
            <ol className="space-y-2 list-decimal list-inside font-sans text-muted-foreground">
              <li>Open the <Link href="/tools/svg-to-pdf" className="text-brand underline font-semibold">Dedicated Tool Workspace</Link> in your web browser.</li>
