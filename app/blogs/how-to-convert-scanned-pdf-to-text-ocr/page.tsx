...
export const metadata: Metadata = {
  title: 'How to Convert Scanned PDF Documents to Text (Online OC...',
  ...
  openGraph: {
    title: 'How to Convert Scanned PDF s to Text Free (Online OCR)',
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify([
            ...articleSchema({
          title: 'How to Convert Scanned PDF to Text (Free) | iCreatePDF',
        ...
        <div className="text-foreground/70 space-y-6 leading-relaxed text-sm sm:text-base">
          ...
          <div className="p-6 rounded-2xl bg-card border border-foreground/10 space-y-3 my-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-xs sm:text-sm text-foreground/75 pl-1">
              <li><strong>OCR Searchability:</strong> Scan flat page images and convert them into copyable, searchable text.</li>
              <li><strong>Language Support:</strong> Use client-side Tesseract models for accurate multi-language parsing.</li>
