        ...
        <div className="text-foreground/70 space-y-6 leading-relaxed text-sm sm:text-base">
          ...
          <div className="p-6 rounded-2xl bg-card border border-foreground/10 space-y-3 my-6">
            ...
            <ul className="list-disc list-inside space-y-2 text-xs sm:text-sm text-foreground/75 pl-1">
              <li><strong>Text Overlay:</strong> Add text overlays, signatures, and date stamps to existing PDF pages.</li>
              <li><strong>No Server Storage:</strong> Prevents files from being saved on third-party cloud platforms.</li>
