    ...
    <div className="bg-background min-h-screen text-foreground flex flex-col justify-between selection:bg-brand/30">
      ...
      <article className="max-w-3xl mx-auto px-6 py-32 space-y-10 flex-1 w-full">
        ...
        <div className="text-foreground/70 space-y-6 leading-relaxed text-sm sm:text-base">
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">What Are the Origins and Definition of Bates Numbering?</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">What is the Anatomy of a Bates Number?</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Why is Sequential Page Stamping Crucial for Legal Discovery?</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">How Can You Add Bates Stamps to a PDF with iCreatePDF?</h2>
