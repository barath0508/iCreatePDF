...
export const metadata: Metadata = {
  title: 'How to Export PDF Form Data to CSV — Survey Guide | iCr...',
...
export default function HowTo_export_pdf_form_dataPage() {
  return (
      ...
      <main className="pt-24 pb-20">
        <article className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-sm text-foreground/80 leading-relaxed">
            ...
            <p>Extract filled AcroForm input fields from single or multiple PDFs into a consolidated CSV spreadsheet.</p>
            ...
            <ol className="space-y-2 list-decimal list-inside font-sans text-muted-foreground">
              <li>Open the <Link href="/export-pdf-form-data" className="text-brand underline font-semibold">Dedicated Tool Workspace</Link> in your web browser.</li>
