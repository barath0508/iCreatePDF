...
const blogPosts = [
  ...
  {
    slug: 'how-to-create-n-up-pdf',
    title: 'How to Create N-up PDF Pages — Free Multi-Page Grid Guide',
    excerpt: 'Learn how to place 2, 4, 6, or 9 PDF pages onto a single sheet of paper for handouts and paper-saving printing.',
    date: 'July 25, 2026',
    readTime: '4 min read',
    category: 'Printing & Layout',
    color: 'blue',
  },
  {
  ...
  },
  {
    ...
    excerpt: 'Pull embedded JPEG and PNG photos out of PDF files and download them as a ZIP archive.',
    date: 'July 25, 2026',
    readTime: '3 min read',
  ...
  {
    slug: 'how-to-export-pdf-form-data',
    title: 'How to Export PDF Form Data to CSV — Free Survey Guide',
    excerpt: 'Extract filled AcroForm input fields from single or multiple PDFs into a consolidated CSV spreadsheet.',
    date: 'July 25, 2026',
    readTime: '4 min read',
  ...
  {
    slug: 'how-to-listen-to-pdf-audio',
    title: 'How to Listen to PDF Audio Hands-Free — Text-to-Speech Guide',
    excerpt: 'Listen to PDF textbook text using natural browser speech synthesis voices offline.',
    date: 'July 25, 2026',
    readTime: '3 min read',
  ...
  {
    slug: 'how-to-stamp-pdf-pages',
    title: 'How to Stamp APPROVED or CONFIDENTIAL on PDF — Free Guide',
    excerpt: 'Stamp APPROVED, CONFIDENTIAL, DRAFT, or custom status text across all PDF pages.',
    date: 'July 25, 2026',
    readTime: '3 min read',
  ...
  {
    slug: 'how-to-apply-pdf-reading-themes',
    title: 'How to Apply Sepia & Dark Reading Themes to PDF — Free Guide',
    excerpt: 'Apply Sepia, Soft Amber, and Dark Mode color filters to PDF document pages to reduce eye strain.',
    date: 'July 25, 2026',
    readTime: '3 min read',
    category: 'Reading Utilities',
    color: 'purple',
  },
  {
    slug: 'how-to-audit-pdf-security',
    title: 'How to Audit PDF Security & Permissions — Security Guide',
    excerpt: 'Inspect PDF encryption algorithms (AES-128/256) and copy/print restriction bitmasks.',
    date: 'July 25, 2026',
    readTime: '4 min read',
    category: 'Security & Privacy',
    color: 'emerald',
  ...
  {
    slug: 'how-to-build-pdf-table-of-contents',
    title: 'How to Build PDF Bookmarks & Table of Contents — Guide',
    excerpt: 'Create clickable outline bookmarks and interactive Table of Contents trees for eBooks.',
    date: 'July 25, 2026',
    readTime: '4 min read',
    category: 'Navigation',
    color: 'blue',
  },
  {
    ...
    excerpt: 'Convert EPUB eBook files into clean, printable A4 PDF documents with formatted chapters.',
    date: 'July 25, 2026',
    readTime: '4 min read',
    category: 'Converters',
    color: 'purple',
  },
  {
    ...
    excerpt: 'Convert Scalable Vector Graphics (.svg) files into high-resolution vector PDF documents.',
    date: 'July 25, 2026',
    readTime: '3 min read',
    category: 'Converters',
    color: 'amber',
  },
  {
    ...
    excerpt: 'Turn raw CSV spreadsheet rows directly into structured, paginated PDF tables with headers.',
    date: 'July 25, 2026',
    readTime: '4 min read',
    category: 'Converters',
    color: 'emerald',
  ...
  {
    slug: 'how-to-adjust-pdf-margins',
    title: 'How to Adjust PDF Margins Online — Free Layout Padding Guide',
    excerpt: 'Add extra border margins for binder hole punching or handwritten notes, processed 100% locally.',
    date: 'July 25, 2026',
    readTime: '3 min read',
  ...
  {
    slug: 'how-to-equalize-pdf-page-sizes',
    title: 'How to Equalize PDF Page Sizes — Free Normalization Guide',
    excerpt: 'Standardize mixed Letter, Legal, and A4 pages into a uniform PDF layout for clean printing.',
    date: 'July 25, 2026',
    readTime: '3 min read',
    category: 'Document Setup',
    color: 'purple',
  ...
  {
    slug: 'how-to-auto-crop-pdf-margins',
    title: 'How to Auto-Crop PDF Margins & Trim Scanner White Borders',
    excerpt: 'Detect and trim uneven scanned borders, black photocopy edges, and excess white margins automatically in browser memory.',
    date: 'August 1, 2026',
    readTime: '4 min read',
    category: 'Document Optimization',
    color: 'emerald',
  },
  {
    ...
    title: 'How to Auto-Redact Sensitive Data & PII from PDF Documents',
    excerpt: 'Automatically scan and permanently redact Social Security numbers, credit card numbers, and confidential contact details locally.',
    date: 'August 1, 2026',
    readTime: '5 min read',
    category: 'Security & Privacy',
    color: 'purple',
  ...
  {
    slug: 'how-to-compare-pdf-visual-diff',
    title: 'How to Compare Two PDF Files with Synchronized Visual Diff',
    excerpt: 'Audit contract redlines and revision drafts side-by-side with locked-step dual page scrolling and visual change highlighting.',
    date: 'August 1, 2026',
    readTime: '4 min read',
  ...
  },
  {
    ...
    title: 'How to Convert Excel Spreadsheets (.xlsx, .xls) to Clean PDF Tables',
    excerpt: 'Convert multi-sheet Excel workbooks into beautifully formatted PDF tables with custom margins and repeated header rows.',
    date: 'August 1, 2026',
    readTime: '4 min read',
    category: 'Converters',
    color: 'emerald',
  ...
  {
    slug: 'how-to-create-interactive-3d-pdf-flipbook',
    title: 'How to Create an Interactive 3D PDF Flipbook Online',
    excerpt: 'Transform flat PDF catalogs, magazines, and portfolios into realistic 3D page-turning web presentations with WebGL.',
    date: 'August 1, 2026',
    readTime: '4 min read',
  ...
  {
    slug: 'how-to-manage-and-embed-pdf-attachments',
    title: 'How to Manage, Extract & Embed File Attachments in PDF',
    excerpt: 'Embed auxiliary spreadsheets, XML schemas, and raw data files directly into the PDF FileSpec dictionary for unified archival.',
    date: 'August 1, 2026',
    readTime: '5 min read',
    category: 'PDF Management',
    color: 'pink',
  ...
  {
    slug: 'how-to-present-pdf-slideshow-laser-pointer',
    title: 'How to Present PDF Slide Decks with a Digital Laser Pointer',
    excerpt: 'Deliver webinars and live slide presentations directly from PDF with glowing laser trails, digital ink pens, and presenter timers.',
    date: 'August 1, 2026',
    readTime: '4 min read',
