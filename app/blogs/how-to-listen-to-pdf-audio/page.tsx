...
export default function HowTo_listen_to_pdf_audioPage() {
  return (
      ...
      <main className="pt-24 pb-20">
        <article className="max-w-4xl mx-auto px-6 lg:px-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-sm text-foreground/80 leading-relaxed">
            ...
            <p>Listen to PDF textbook text using natural browser speech synthesis voices offline.</p>
            ...
            <ol className="space-y-2 list-decimal list-inside font-sans text-muted-foreground">
              <li>Open the <Link href="/tools/pdf-to-audio" className="text-brand underline font-semibold">Dedicated Tool Workspace</Link> in your web browser.</li>
