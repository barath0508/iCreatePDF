...
export const metadata: Metadata = {
  ...
  keywords: 'scan text from pdf, pdf ocr to text, free ocr pdf to text, online ocr pdf, turn scanned document into text, convert a scanned document to editable text, scanned document to text, scanned pdf to text converter, ocr pdf to text, ocr convert scanned pdf to text, online ocr pdf to text converters, convert ocr pdf, ocr convert pdf to text, convert pdf image to text, convert pdf to machine readable format, scan and ocr pdf, convert scanned pdf to editable text, convert scanned pdf to text online free, ocr for scanned documents, ocr pdf converter, pdf scan ocr, scanned pdf to text, pdf scan to text, scanned pdf to normal pdf, scanned pdf ocr to text, pdf ocr online, scanned pdf to text, extract text from pdf, copy-proof pdf to text ocr, convert scanned pdf to text, local pdf ocr',
