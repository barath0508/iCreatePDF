...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates('/blog/how-to-add-header-footer-to-pdf'),
  openGraph: {
    ...
    <div className="bg-background min-h-screen text-foreground flex flex-col justify-between selection:bg-brand/30">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(articleSchema({
          title: 'How to Add a Header and Footer to a PDF — Free Guide | iCreatePDF',
          description: 'Add custom headers and footers to every page of a PDF — company name, date, page numbers, or any text. 100% browser-based, no uploads.',
          url: '/blog/how-to-add-header-footer-to-pdf',
      ...
      <article className="max-w-3xl mx-auto px-6 py-32 space-y-10 flex-1 w-full">
        ...
        <div className="text-foreground/70 space-y-6 leading-relaxed text-sm sm:text-base">
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Step-by-Step: Add a Header/Footer Using iCreatePDF</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">6 Reasons to Add a Header or Footer</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Headers/Footers vs. Page Numbers vs. Bates Numbering</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">iCreatePDF vs Other Header/Footer Tools</h2>
