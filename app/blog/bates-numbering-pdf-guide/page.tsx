...
export const metadata: Metadata = {
  ...
  alternates: { canonical: '/blog/bates-numbering-pdf-guide' },
  openGraph: {
    ...
    <div className="bg-black min-h-screen text-white flex flex-col justify-between selection:bg-purple-500/30">
      ...
      <article className="max-w-3xl mx-auto px-6 py-32 space-y-10 flex-1 w-full">
        ...
        <div className="text-white/70 space-y-6 leading-relaxed text-sm sm:text-base">
          ...
          <h2 className="text-xl font-bold text-white pt-4 font-display">The Origins &amp; Definition</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-white pt-4 font-display">Anatomy of a Bates Number</h2>
          <p>
            A typical Bates stamp consists of three parts:
          </p>
          <ul className="list-disc list-inside space-y-2 pl-4 text-sm">
            <li><strong className="text-white">Prefix:</strong> Identifies the source or party (e.g., <code className="text-purple-400 font-mono">PLAINTIFF-</code> or <code className="text-purple-400 font-mono">SMITH-</code>).</li>
            <li><strong className="text-white">Padded Number:</strong> A padded sequence containing leading zeros for sorting (e.g., <code className="text-purple-400 font-mono">000001</code> instead of <code className="text-purple-400 font-mono">1</code>).</li>
            <li><strong className="text-white">Suffix:</strong> Additional context (e.g., <code className="text-purple-400 font-mono">-CONFIDENTIAL</code>).</li>
          </ul>
          <p>Example: <strong className="text-white font-mono">CASE-000142-SECURE</strong></p>

          <h2 className="text-xl font-bold text-white pt-4 font-display">Why Sequential Numbering is Crucial</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 my-4">
            <div className="p-4 rounded-xl bg-zinc-950 border border-white/5 space-y-2">
              <h3 className="font-bold text-white text-sm flex items-center gap-1.5"><Check className="w-4 h-4 text-emerald-400" />Reference Clarity</h3>
              <p className="text-xs text-white/50 leading-normal">Allows attorneys, judges, and clerks to refer to a specific page instantly: "Please see Document Smith-000412."</p>
            </div>
            <div className="p-4 rounded-xl bg-zinc-950 border border-white/5 space-y-2">
              <h3 className="font-bold text-white text-sm flex items-center gap-1.5"><Check className="w-4 h-4 text-emerald-400" />Tamper Evidence</h3>
              <p className="text-xs text-white/50 leading-normal">Missing pages are immediately obvious if there is a gap in the sequential numbering series.</p>
            </div>
          </div>

          <h2 className="text-xl font-bold text-white pt-4 font-display">How to Add Bates Stamps with iCreatePDF</h2>
          <ol className="list-decimal list-inside space-y-2 pl-4 text-sm">
            <li>Navigate to the <Link href="/bates-numbering" className="text-purple-400 hover:underline">/bates-numbering</Link> tool page.</li>
        ...
        <div className="p-6 rounded-2xl bg-gradient-to-r from-purple-950/20 to-pink-950/20 border border-purple-500/20 text-center space-y-4">
          ...
          <p className="text-xs text-white/60 max-w-md mx-auto">Completely client-side. Keep sensitive legal files out of third-party cloud portals.</p>
