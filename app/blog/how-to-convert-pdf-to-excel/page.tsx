...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates('/blog/how-to-convert-pdf-to-excel'),
  openGraph: {
    ...
    <div className="bg-background min-h-screen text-foreground flex flex-col justify-between selection:bg-brand/30">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(articleSchema({
          title: 'How to Convert PDF to Excel Online — Free Guide | iCreatePDF',
          description: 'Extract tables from a PDF into Excel-ready CSV files. Automatic row and column detection, entirely in your browser — no upload, no sign-up.',
          url: '/blog/how-to-convert-pdf-to-excel',
      ...
      <article className="max-w-3xl mx-auto px-6 py-32 space-y-10 flex-1 w-full">
        ...
        <div className="text-foreground/70 space-y-6 leading-relaxed text-sm sm:text-base">
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Step-by-Step: Convert PDF to Excel Using iCreatePDF</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">6 Reasons to Extract a Table from a PDF</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Why Table Extraction Works Better on Some PDFs</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">iCreatePDF vs Other PDF-to-Excel Tools</h2>
