...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates('/blog/how-to-convert-ris-to-pdf-bibliography'),
  openGraph: {
    ...
    <div className="bg-background min-h-screen text-foreground flex flex-col justify-between selection:bg-brand/30">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(articleSchema({
          title: 'How to Convert RIS to PDF (Bibliography & Citations) — Free Guide | iCreatePDF',
          description: 'Parse RIS bibliographic citation files and compile them into a formatted PDF in APA, MLA, Chicago, or Harvard style. 100% browser-based, no uploads.',
          url: '/blog/how-to-convert-ris-to-pdf-bibliography',
      ...
      <article className="max-w-3xl mx-auto px-6 py-32 space-y-10 flex-1 w-full">
        ...
        <div className="text-foreground/70 space-y-6 leading-relaxed text-sm sm:text-base">
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Step-by-Step: Convert RIS to PDF Using iCreatePDF</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">6 Reasons to Convert an RIS File to PDF</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Choosing the Right Citation Style</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">iCreatePDF vs Other RIS Converters</h2>
