...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates('/blog/how-to-convert-html-to-pdf'),
  openGraph: {
    ...
    <div className="bg-background min-h-screen text-foreground flex flex-col justify-between selection:bg-brand/30">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(articleSchema({
          title: 'How to Convert HTML to PDF Online — Free Guide | iCreatePDF',
          description: 'Turn HTML and CSS templates into formatted PDF documents in your browser. No upload, no server rendering — paste code or a template and export instantly.',
          url: '/blog/how-to-convert-html-to-pdf',
      ...
      <article className="max-w-3xl mx-auto px-6 py-32 space-y-10 flex-1 w-full">
        ...
        <div className="text-foreground/70 space-y-6 leading-relaxed text-sm sm:text-base">
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Step-by-Step: Convert HTML to PDF Using iCreatePDF</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">6 Reasons to Convert HTML to PDF</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Tips for Reliable HTML-to-PDF Conversion</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">iCreatePDF vs Other HTML-to-PDF Tools</h2>
