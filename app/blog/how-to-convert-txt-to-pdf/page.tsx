...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates('/blog/how-to-convert-txt-to-pdf'),
  openGraph: {
    ...
    <div className="bg-background min-h-screen text-foreground flex flex-col justify-between selection:bg-brand/30">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(articleSchema({
          title: 'How to Convert TXT to PDF Online — Free Guide | iCreatePDF',
          description: 'Convert plain text (.txt) files or pasted text into styled PDF documents. Customize margins, page size, and fonts, entirely in your browser.',
          url: '/blog/how-to-convert-txt-to-pdf',
      ...
      <article className="max-w-3xl mx-auto px-6 py-32 space-y-10 flex-1 w-full">
        ...
        <div className="text-foreground/70 space-y-6 leading-relaxed text-sm sm:text-base">
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Step-by-Step: Convert TXT to PDF Using iCreatePDF</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">6 Reasons to Convert Text to PDF</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Plain Text vs. Markdown Formatting</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">iCreatePDF vs Other Text-to-PDF Tools</h2>
