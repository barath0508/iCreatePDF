...
export const metadata: Metadata = {
  ...
  alternates: buildAlternates('/blog/how-to-compare-two-pdf-files'),
  openGraph: {
    ...
    <div className="bg-background min-h-screen text-foreground flex flex-col justify-between selection:bg-brand/30">
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(articleSchema({
          title: 'How to Compare Two PDF Files Side-by-Side — Free Guide | iCreatePDF',
          description: 'Compare two PDF document versions side-by-side with synchronized scrolling to spot content differences instantly. 100% browser-based, no uploads.',
          url: '/blog/how-to-compare-two-pdf-files',
      ...
      <article className="max-w-3xl mx-auto px-6 py-32 space-y-10 flex-1 w-full">
        ...
        <div className="text-foreground/70 space-y-6 leading-relaxed text-sm sm:text-base">
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Step-by-Step: Compare PDFs Using iCreatePDF</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">6 Reasons to Compare PDF Versions</h2>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">Visual Comparison vs. Text Diffing</h2>
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground pt-4 font-display">iCreatePDF vs Other PDF Comparison Tools</h2>
