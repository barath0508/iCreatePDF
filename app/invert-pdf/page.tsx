...
export const metadata: Metadata = { title: 'Invert PDF Colors Online Free - Dark Mode PDF | iCreatePDF', description: 'Invert the colors of your PDF to create a dark mode version. Ideal for night reading, reducing eye strain, and saving white ink when printing.', keywords: 'invert pdf colors, dark mode pdf, pdf color inverter, night mode pdf, invert pdf online free', alternates: { canonical: '/invert-pdf' } };
