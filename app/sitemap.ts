...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const toolRoutes = [
    ...
    '/tools/n-up-pdf',
    '/tools/booklet-pdf',
    '/tools/adjust-pdf-margins',
    '/tools/equalize-pdf-page-sizes',
    '/tools/pdf-to-word',
    '/tools/extract-pdf-images',
    '/tools/export-pdf-form-data',
    '/tools/pdf-to-audio',
    '/tools/stamp-pdf',
    '/tools/pdf-reading-themes',
    '/tools/pdf-security-auditor',
    '/tools/pdf-toc-builder',
    '/tools/epub-to-pdf',
    '/tools/svg-to-pdf',
    '/tools/csv-to-pdf',
  ];
